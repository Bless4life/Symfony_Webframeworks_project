 ...
 */
final class Version20210423153159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD books_id INT DEFAULT NULL, DROP num_books');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD num_books INT NOT NULL, DROP books_id');
    }
}
